...
public class WriterClient2 {
    ...
    private static void readEchoAndRepeat(SocketChannel socket) throws IOException {
        ...
        while (true) {
            String line = "httpfs post http://localhost:8080//Users/hongyushen/Documents/IntelliJProject/COMP6461-httpServerApplication/working-directory1/foo.txt -d ‘net??????’ overwrite=true";
